...
public class MealsUtil {
    ...
    public final static List<Meal> MEAL_LIST = Arrays.asList(
            ...
            new Meal(1, LocalDateTime.of(2016, Month.MAY, 31, 10, 0), "Завтрак", 1000),
            new Meal(1, LocalDateTime.of(2016, Month.MAY, 31, 13, 0), "Обед", 500),
            new Meal(1, LocalDateTime.of(2016, Month.MAY, 31, 20, 0), "Ужин", 510)
    );
