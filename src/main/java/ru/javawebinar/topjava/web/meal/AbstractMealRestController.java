...
public class AbstractMealRestController {
    private static final Logger LOG = getLogger(AbstractMealRestController.class);
    @Autowired
    ...
    public void update(MealTo editedMeal)
    {
        int userId = AuthorizedUser.id();
        LOG.info("Update meal={} for user={}", editedMeal, userId);
        mealService.update(editedMeal, userId);
    }
